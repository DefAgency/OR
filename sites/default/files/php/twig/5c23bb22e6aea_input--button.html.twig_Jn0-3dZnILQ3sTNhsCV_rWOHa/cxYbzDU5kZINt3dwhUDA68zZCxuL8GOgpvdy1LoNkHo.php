...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/home/defagenc/public_html/OR/TEMP/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
}
